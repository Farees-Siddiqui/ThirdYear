 ...
 * uniform block in our shader.  Give it the
 * same initial values that we had before.
 */
...
void init() {
	 ...
	 */
	sprintf(vname,"../src/example8%s.vs", vertexName);
	sprintf(fname,"../src/example8%s.fs", fragmentName);
...
int main(int argc, char **argv) {
	...
	window = glfwCreateWindow(512, 512, "Example Eight A", NULL, NULL);
