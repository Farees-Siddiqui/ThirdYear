...
void init() {
	...
	std::string err = tinyobj::LoadObj(shapes, materials, "../src/sphere.obj", 0);
...
#else
	texture = loadCube((char*)(char*)"../VancouverConventionCentre");
#endif
...
int main(int argc, char **argv) {
	...
	window = glfwCreateWindow(512, 512, "Assignment03", NULL, NULL);
